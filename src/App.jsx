...
import College from './scenes/College/College';
            ...
            {(isAuthenticated && uid && student!=null) ? <div className='app flex  '>
              ...
              <main className='w-full'>
                ...
                <Routes>
                  ...
                  <Route path={`/:username/College`} exact element={<College />}></Route>
                  <Route path={`/:username/work`} exact element={<Work />}></Route>
                  <Route path={`/:username/certificates`} exact element={<Certificates />}></Route>
                  <Route path={`/:username/qr`} exact element={<QR />}></Route>
